...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 4l1.414 1.414A10 10 0 1 1 5.414 5.414L4 4z" />
    <path d="M12 12L8 8" />
    <path d="M12 12l4 4" />
    <path d="M12 12l4-4" />
    <path d="M12 12l-4 4" />
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M18 8.86a4.5 4.5 0 01-1.34 3.14 4.5 4.5 0 01-3.14 1.34 4.5 4.5 0 01-3.14-1.34 4.5 4.5 0 01-1.34-3.14 4.5 4.5 0 011.34-3.14 4.5 4.5 0 013.14-1.34 4.5 4.5 0 013.14 1.34 4.5 4.5 0 011.34 3.14z"/>
...
export const HeartPulseIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M3.5 12h3l2.5-9 4 18 2.5-9h3"></path>
    </svg>
);
...
export const SoccerBallIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="12" cy="12" r="10"></circle>
        <path d="M12 2a10 10 0 0 0-4.95 1.82m-1.23 2.51A10 10 0 0 0 2 12m1.82 4.95a10 10 0 0 0 2.51 1.23M12 22a10 10 0 0 0 4.95-1.82m1.23-2.51A10 10 0 0 0 22 12m-1.82-4.95a10 10 0 0 0-2.51-1.23"></path>
...
export const ClipboardPlusIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
